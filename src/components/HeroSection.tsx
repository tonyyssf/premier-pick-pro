...
export const HeroSection: React.FC = () => {
  return (
    <div className="relative bg-gradient-to-r from-emerald-600 to-blue-600 py-24">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <p className="text-emerald-100">Only 2 picks per team all season. Choose your moments wisely!</p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <Trophy className="h-12 w-12 text-white mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-white mb-2">Simple Scoring</h3>
              <p className="text-emerald-100">3 points for wins, 1 for draws, 0 for losses. Every point counts!</p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <Users className="h-12 w-12 text-white mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-white mb-2">Compete Together</h3>
              <p className="text-emerald-100">Join private leagues with friends or climb the global leaderboard!</p>
            </div>
          </div>
        </div>
      </div>
