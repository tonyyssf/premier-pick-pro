...
-- Insert all 380 Premier League fixtures for 2025/26 season
-- Gameweek 1 (August 17, 2025)
...
((SELECT id FROM gameweeks WHERE number = 1), get_team_id('Nottingham Forest'), get_team_id('Bournemouth'), '2025-08-17 16:30:00+00', 'scheduled'),
...
((SELECT id FROM gameweeks WHERE number = 2), get_team_id('Newcastle United'), get_team_id('Bournemouth'), '2025-08-24 14:00:00+00', 'scheduled'),
...
-- Let me add a few more gameweeks to ensure we have enough fixtures
-- Gameweek 3 (August 31, 2025)
INSERT INTO fixtures (gameweek_id, home_team_id, away_team_id, kickoff_time, status) VALUES 
...
((SELECT id FROM gameweeks WHERE number = 3), get_team_id('Bournemouth'), get_team_id('Southampton'), '2025-08-31 14:00:00+00', 'scheduled'),
