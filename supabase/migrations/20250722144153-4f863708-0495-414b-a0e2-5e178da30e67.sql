...
-- Update the get_app_fixtures_for_gameweek function to return fixtures sorted by kickoff time
...
BEGIN
  ...
  SELECT 
    ...
    -- Parse the date and time properly from the fixtures table with better handling
    CASE 
